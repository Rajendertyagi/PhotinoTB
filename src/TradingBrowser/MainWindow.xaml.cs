...
public sealed partial class MainWindow : Window
{
    ...
    private void SetupEventHooks()
    {
        ...
        ViewModel.NavigationRequested += url => { 
            if (_isWebViewInitialized) MainWebView.CoreWebView2.Navigate(url); 
        };
        ...
        ViewModel.OpenDevToolsRequested += () => { 
            if (_isWebViewInitialized) MainWebView.CoreWebView2.OpenDevToolsWindow(); 
        };
    ...
    // UPDATED: Navigates to Settings page instead of showing dialog
